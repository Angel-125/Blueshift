...
- Warp Pylon Type A: This part has several variants that let you separate your warp nacelles from the rest of the ship.

Bug Fixes

- Fixed issue with missing wbiElectroPlasma resource.
