...
Changes
- Warp engines now support Firefly! You'll need Firefly 1.0.5.0 or greater to see the new effects. Be sure to install the FireflyAPI (included) along with Blueshift.
